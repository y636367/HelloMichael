...
public class Option_BTN : MonoBehaviour
{
    ...
    private void Find_Objects()
    {
        ...
        GameObject Game_Control = Panels.transform.Find("PanelGame_Controls").gameObject;
        GameObject Video = Panels.transform.Find("PanelVideo").gameObject;
        GameObject KeyBinding = Panels.transform.Find("PanelKeyBindings").gameObject;

        Smooth_Slider = Game_Control.transform.Find("SmoothingSlider").gameObject.GetComponent<Slider>();
        Inverse = Game_Control.transform.Find("Inverse_Btn").gameObject.GetComponent<Button>();

        Done_ = Video.transform.Find("Btn_Done").gameObject.GetComponent<Button>();
        FullScreen_ = Video.transform.Find("FullScreen_Btn").gameObject.GetComponent<Button>();
        Shadow_Off = Video.transform.Find("ShadowOff_Btn").gameObject.GetComponent<Button>();
        Shadow_Low = Video.transform.Find("ShadowLow_Btn").gameObject.GetComponent<Button>();
        Shadow_High = Video.transform.Find("ShadowHigh_Btn").gameObject.GetComponent<Button>();
        Texture_Low = Video.transform.Find("TextureLow_Btn").gameObject.GetComponent<Button>();
        Texture_Med = Video.transform.Find("TextureMed_Btn").gameObject.GetComponent<Button>();
        Texture_High = Video.transform.Find("TextureHigh_Btn").gameObject.GetComponent<Button>();

        GameObject MoveMentPanel = KeyBinding.transform.Find("MovementPanel").gameObject;
        GameObject ActionPanel = KeyBinding.transform.Find("ActonPanel").gameObject;
        GameObject GeneralPanel = KeyBinding.transform.Find("GeneralPanel").gameObject;
